...
describe('RedisClient', () => {
    ...
    it("should retrieve a hash table from Redis cache by key", function() {
        redisClient.hmset("testHash", { key1: "value1", key2: "value2" })
    ...
    it('should save a hash table in Redis cache', function() {
        // this.timeout(10000)
        redisClient.hmset("myHashKey", { field1: "value1", field2: "value2" })
    ...
    it('should check if a hash with a specific key exists', function() {
        // this.timeout(10000)
        redisClient.hmset("myHashKey", { key: "value", key1: "value" })
   ...
   it("should retrieve a value from Redis cache by key", function() {
    redisClient.client.set("myKey", "myValue")
    .then(() => {
    ...
    it("should retrieve a hash table from Redis cache by key", function() {
     redisClient.client.hmsetAsync("myHashKey", { field1: "value1", field2: "value2" })
     .then(() => {
