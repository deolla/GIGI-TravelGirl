// import redisClient from "../Backend/webCache/RedisClient.js";
...
// exampleUsage().catch((err) => console.error("Error:", err));
...
// // Example usage:
// getAirportCode("Lagos")
//   .then((airportCode) => console.log(`Airport code for Lagos: ${airportCode}`))
