        ...
        <div className='bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5'>
            ...
            <div className='sm:w-1/2 px-10'>
                ...
                <form action="" className='flex flex-col gap-4'>
                    <input type="email" name="email" id="email" placeholder='Email' className='p-2 mt-8 border rounded-xl'/>
                ...
                <button type="submit" className='text-sm flex items-center justify-center bg-white border py-2 w-full rounded-xl mt-5'>
                    <svg className='mr-3' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25px" height="25px" viewBox="0 0 48 48">
                        ...
                        <div className='w-full flex items-center justify-center'>
                            <p className='text-[#060606] text-sm font-normal'>Don&apos;t have an account yet? <Link to="#" onClick={onToggleForm} className='text-primary font-semibold underline underline-offset-2 cursor-pointer'>Signup</Link></p>
                            </div>
